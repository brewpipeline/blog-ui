...
#[function_component(UnsubscribedImg)]
pub fn search_img() -> Html {
    html! {
        <svg aria-label="Отписка" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bell-slash-fill" viewBox="0 0 16 16">
...
#[function_component(SubscribedImg)]
pub fn search_img() -> Html {
    html! {
        <svg aria-label="Подписька" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bell-fill" viewBox="0 0 16 16">
